...
public class ListaParejaMod extends JFrame {
	...
	public ListaParejaMod() {
		...
		JLabel lblSeleccioneParejaA = new JLabel("Seleccione Pareja a modificar:");
		...
		JButton btnModificar = new JButton("Modificar Pareja");
